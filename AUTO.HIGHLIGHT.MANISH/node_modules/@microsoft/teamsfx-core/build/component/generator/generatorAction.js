...
exports.DownloadDirectoryActionSeq = exports.SampleActionSeq = exports.TemplateActionSeq = exports.unzipAction = exports.fetchTemplateFromLocalAction = exports.fetchZipFromUrlAction = exports.fetchTemplateUrlWithTagAction = exports.downloadDirectoryAction = exports.fetchSampleInfoAction = exports.fetchTemplateZipFromSourceCodeAction = exports.GeneratorActionName = void 0;
...
exports.fetchTemplateZipFromSourceCodeAction = {
    ...
    run: (context) => {
        ...
        const templateSourceCodePath = path_1.default.resolve(__dirname, "../../../../../", "templates", context.language);
...
exports.fetchTemplateUrlWithTagAction = {
    ...
    run: async (context) => {
        ...
        context.url = await utils_1.fetchTemplateZipUrl(context.language, context.tryLimits, context.timeoutInMs);
    },
};
...
exports.DownloadDirectoryActionSeq = [
    exports.fetchSampleInfoAction,
    exports.downloadDirectoryAction,
];
