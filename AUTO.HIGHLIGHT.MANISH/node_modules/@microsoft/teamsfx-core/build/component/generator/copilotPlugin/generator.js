    ...
    static async generateForME(context, inputs, destinationPath, templateName, componentName, apiKeyAuthData) {
        ...
        try {
            ...
            if (apiKeyAuthData === null || apiKeyAuthData === void 0 ? void 0 : apiKeyAuthData.authName) {
                context.templateVariables = generator_1.Generator.getDefaultVariables(appName, safeProjectNameFromVS, inputs.targetFramework, {
            ...
            const specParser = new spec_parser_1.SpecParser(url, { allowAPIKeyAuth, allowMultipleParameters });
