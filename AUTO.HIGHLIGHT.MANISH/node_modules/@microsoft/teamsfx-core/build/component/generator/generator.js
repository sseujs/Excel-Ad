...
class Generator {
    static getDefaultVariables(appName, safeProjectNameFromVS, targetFramework, apiKeyAuthData) {
        var _a, _b, _c;
    ...
    static async generateTemplate(ctx, destinationPath, scenario, language, actionContext) {
        ...
        const generatorContext = {
            name: scenario,
            language: language !== null && language !== void 0 ? language : constant_1.commonTemplateName,
