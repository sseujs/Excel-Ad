...
export declare class MissingResourceAppIdUserError extends UserError {
    constructor(actionName: string);
}
export declare class MissingResourceAccessIdUserError extends UserError {
    constructor(actionName: string);
}
...
export declare class DeleteOrUpdatePermissionFailedError extends UserError {
    constructor(actionName: string);
}
export declare class HostNameNotOnVerifiedDomainError extends UserError {
